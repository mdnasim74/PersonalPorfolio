...
const About = () => {
  return (
    <section id='about' className='py-1 px-[5vw] lg:px-[16vw] font-sans mt-16 md:mt-24 lg:mt-32'>
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        ...
        <div className='md:w-1/2 flex justify-center md:justify-end'>
          <Tilt className='w-48 h-48 sm:w-64 sm:h-64 md:w-[26rem] md:h-[26rem] border-4 border-purple-700 rounded-full'
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.04}
            ...
            gyroscope={true}>
            <img src={ProfileImage} alt="Md Nasim Ansari"
